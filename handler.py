...
def handler(job):
    ...
    prompt["135"]["inputs"]["negative_prompt"] = job_input.get("negative_prompt", "changing clothes, different outfit, color shift, fabric change, wardrobe change, clothing transformation, different color clothing, outfit modification, bright tones, overexposed, static, blurred details, subtitles, style, works, paintings, images, static, overall gray, worst quality, low quality, JPEG compression residue, ugly, incomplete, extra fingers, poorly drawn hands, poorly drawn faces, deformed, disfigured, misshapen limbs, fused fingers, still picture, messy background, three legs, many people in the background, walking backwards")
